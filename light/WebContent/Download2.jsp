    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="blog.html"><span>END users </span></a></li>
          <li></li>
        </ul>
      </div>
      <div class="clr"></div>
      ...
      <div class="slider">
        <div id="coin-slider"> 
          <p><a href="#"><img src="images/slide1.jpg" width="920" height="320" alt="" /><span><big>Sed </big></span></a><a href="index.html" class="style2">Lightweight Fine-Grained Search over Encrypted Data <br />
              <br />
in Fog Computing</a> <a href="#"><img src="images/slide2.jpg" width="920" height="320" alt="" /></a><a href="#"><span><big>The </big></span></a><a href="index.html" class="style2">Lightweight Fine-Grained Search over Encrypted Data <br />
<br />
in Fog Computing</a> <a href="#"><img src="images/slide3.jpg" width="920" height="320" alt="" /></a><a href="index.html" class="style2">Lightweight Fine-Grained Search over Encrypted Data <br />
<br />
in Fog Computing</a> </p>
        </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
