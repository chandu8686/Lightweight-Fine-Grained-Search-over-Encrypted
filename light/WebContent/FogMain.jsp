...
in Fog Computing</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to Fog Node Main:: <%=application.getAttribute("proxyname") %></h2>
          <p align="justify" class="infopost style3">&nbsp;</p>
          <div class="clr style3"><img src="images/Home.png" width="620" height="259" /></div>
      ...
      <div class="sidebar">
        ...
        <div class="clr"></div>
        <div class="gadget">
          <h2 class="star"><span>Fog</span> Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="PROXYMain.jsp">Home</a></li>
			
            <li><a href="Fog_keyauth.jsp">View Request and Authorize PKC </a></li>
			<li><a href="Fog_transactions.jsp">View Transactions </a></li>
