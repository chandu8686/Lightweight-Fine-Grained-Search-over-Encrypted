      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="KGCKeyGenerator.jsp">View Request and Generate Key </a></li>
